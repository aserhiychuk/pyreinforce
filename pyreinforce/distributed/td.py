...
class AsyncTdAgent(DistributedAgent):
    def __init__(self, n_episodes, env, brain, acting, experience_buffer, gamma, train_freq,
                 validation_freq=None, validation_episodes=None,
                 converter=None, callback=None, n_workers=None):
        super().__init__(n_episodes, env, brain, experience_buffer, train_freq,
    ...
    def _create_worker(self, worker_no, conn_to_parent, shared_weights, barrier,
        ...
        acting = self._acting(worker_no) if callable(self._acting) else self._acting
        ...
        worker = TdWorker(worker_no, conn_to_parent, shared_weights, barrier,
                          self._n_episodes, env, brain, acting, self._experience_buffer,
                          self._gamma, self._train_freq, self._validation_freq, validation_episodes,
...
class TdWorker(WorkerAgent):
    def __init__(self, worker_no, conn_to_parent, shared_weights, barrier,
                 n_episodes, env, brain, acting, experience_buffer, gamma, train_freq,
        ...
        super().__init__(worker_no, conn_to_parent, shared_weights, barrier,
                         ...
                         validation_freq, validation_episodes, converter, callback)
